      ...
      <div className="mx-auto max-w-6xl space-y-4">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          ...
          <Button
            onClick={onBack}
            variant="ghost"
            className="h-10 w-fit rounded-full border border-white/[0.08] bg-white/[0.035] px-4 text-sm text-white/72 hover:bg-white/[0.07] hover:text-white"
          >
        ...
        <div className="grid gap-3 lg:grid-cols-2">
          ...
          <Card className={`${cardClassName} flex flex-col space-y-3`}>
            ...
            <div>
              ...
              <div className="relative mt-2">
                <Mail className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-white/52" />
                <Input
                  id="account-email"
                  type="email"
                  value={pendingEmail}
            ...
            {accountError ? (
              <div className="rounded-2xl bg-[#11141D] px-4 py-3 text-sm text-[#ef8b82]">
                {accountError}
              </div>
            ) : null}
          ...
          <Card className={`${cardClassName} flex flex-col space-y-3`}>
            ...
            <div className="mt-auto pt-1">
              <Button
                ...
                disabled={!user || isUpdatingPassword}
                className="h-10 w-full rounded-xl app-secondary-btn"
              >
          ...
          <Card className={`${cardClassName} flex flex-col space-y-3`}>
            ...
            <div className="flex items-start gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-[#ef6b63]/30 bg-[rgba(239,107,99,0.12)]">
                <OctagonAlert className="h-4 w-4 text-[#ef6b63]" />
              </div>
              <div>
                <h2 className="text-lg font-semibold text-[#F5F2F7]">Compte</h2>
                <p className="text-xs leading-5 app-muted">
                  Déconnecte-toi ou supprime définitivement ton compte.
                </p>
              </div>
            </div>
            ...
            <div className="mt-auto space-y-2.5 border-t border-white/[0.06] pt-3">
              ...
              <Button
                ...
                className="h-11 w-full rounded-xl bg-[#ef6b63] px-4 text-white hover:bg-[#e15d55]"
              >
