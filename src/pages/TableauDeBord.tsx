    ...
    <div className="min-h-screen bg-[#0B0D10] text-[#ECECF3] p-6 md:p-10">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-[1.1fr,1.4fr] items-start">
          {/* Pomodoro */}
          <section className="bg-[#13151C] border border-[#1F2230] rounded-3xl p-6 shadow-[0_14px_40px_rgba(0,0,0,0.45),0_1px_0_rgba(255,255,255,0.04)]">
            <div className="mb-2">
        ...
        {/* Agenda en ligne */}
        <section className="bg-[#13151C] border border-[#1F2230] rounded-3xl p-6 shadow-[0_14px_40px_rgba(0,0,0,0.45),0_1px_0_rgba(255,255,255,0.04)] space-y-2">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          <div className="bg-[#13151C] border border-[#1F2230] rounded-3xl p-4 shadow-[0_14px_40px_rgba(0,0,0,0.45),0_1px_0_rgba(255,255,255,0.04)] flex flex-col gap-1">
        ...
        {showAddDialog && (
          <div className="fixed inset-0 z-50 flex min-h-screen w-screen items-center justify-center bg-black/40 px-3 py-4 sm:px-4 sm:py-6">
            <div className="bg-[#13151C] border border-[#1F2230] shadow-[0_18px_50px_rgba(0,0,0,0.55),0_1px_0_rgba(255,255,255,0.05)] max-w-3xl w-full p-4 sm:p-6 relative max-h-[90vh] overflow-y-auto">
